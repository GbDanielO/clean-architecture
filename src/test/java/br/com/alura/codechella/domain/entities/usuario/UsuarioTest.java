...
public class UsuarioTest {
	...
	@Test
	public void naoCadastrarComCpfNoFormaoInvalido() {
		...
		Assertions.assertThrows(IllegalArgumentException.class,
				() -> new Usuario(null, "Jacque", LocalDate.parse("1990-09-08"), "email@email.com"));
	}
	...
	@Test
	public void deveCriarUsuarioUsandoPadraoBuilder() {
		UsuarioBuilder builder = new UsuarioBuilder();

		Usuario usuario = builder.comNomeCpfNascimento("Emily", "654.123.897-88", LocalDate.parse("2000-10-01"));

		Assertions.assertEquals("Emily", usuario.getNome());

		usuario = builder.incluiEndereco("12345-999", 40, "apto 201");
